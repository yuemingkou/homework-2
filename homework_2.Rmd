...
state_count
```
`r nrow(distinct(brfss_data,locationdesc))` unique locations are included in the dataset.
...
```
In 2012, the median of the "Excellent" response value is `r median(brfss_2002$excellent, na.rm = TRUE)`
